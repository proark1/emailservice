          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full h-10 px-3.5 bg-white border rounded-xl text-gray-900 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 transition-all ${
                  showEmailError
              ...
              />
              {showEmailError && (
                <p className="text-[11px] text-red-500 mt-1.5">Please enter a valid email</p>
              )}
            </div>
